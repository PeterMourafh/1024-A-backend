...
class MysqlErrorHandler {
    constructor(readonly err: unknown, readonly res: express.Response) { }
    ...
    validar() {
        ...
        if(this.err instanceof Error && 'code' in this.err ){
            ...
            return this.res.status(500).json({ mensagem: "ERRO: Você digitou um valor duplicado, confira o Execute!" })
        }else {
